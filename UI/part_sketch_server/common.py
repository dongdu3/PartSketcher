...
def extract_mesh(occ_hat, threshold=0.2, padding=0.00, n_face_simp=None):
    ...
    occ_hat_padded = np.pad(occ_hat, 0, 'constant', constant_values=-1e6)
    ...
    if vertices.shape[0] == 0:
        return mesh
    #print('n face simple type', type(n_face_simp))
...
def extract_mesh_new(occ_hat, threshold=0.2, padding=0.1, n_face_simp=None):
    ''' Extracts the mesh from the predicted occupancy grid.
