...
class PartNet(data.Dataset):
    def __init__(self,
        ...
        for name in fnames:
            ...
            self.data_paths.append((sket_view_path, pc_occ_path, folder_name, part_name))
    ...
    def __getitem__(self, index):
        # view image data
        sket_view_path, pc_occ_path, folder_name, part_name = self.data_paths[index]
        view_id = '5'
        ...
        return sket_data, occ_data, folder_name, part_name, view_id
...
if __name__ == '__main__':
    ...
    for i, data in enumerate(dataloader, 0):
        sket, occ, folder_name, part_name, view_id = data
        print(sket.shape)
        print(occ[None])
